...
from torch.nn import Sequential, Conv2d, LeakyReLU, MaxPool2d, Flatten, Linear,\
                     Softmax, Module, ReLU
from torch import from_numpy, load, manual_seed
import sys
...
class MNISTModel(Module):
    def __init__(self, restore=None, use_log=False):
        ...
        self.act1 = ReLU()
        self.cv2 = Conv2d(self.output12, self.output12, self.kernel_size)
        self.act2 = ReLU()
        self.max1 = MaxPool2d(self.pool_kernel_size)
        #
        self.cv3 = Conv2d(self.output12, self.output34, self.kernel_size)
        self.act3 = ReLU()
        ...
        self.act5 = ReLU()
        self.fc2 = Linear(self.output56, self.output56)
        self.act6 = ReLU()
        self.fc3 = Linear(self.output56, self.num_labels)
    ...
    def predict(self, data):
        ...
        out = data.permute(0,3,1,2)
        out = self.act1(self.cv1(out))
