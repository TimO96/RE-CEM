...
def main(image_id, arg_max_iter=1000, c_steps=9, init_const=10.0, mode="PN",
         ...
         nn='models/MNIST_MNISTModel.pt', ae='models/MNIST_AE.pt', quant_res=False):
    ...
    elif quant_res==True and mode=='PN' and orig_class!=adv_class:
        return 1

    elif quant_res==True and mode=='PP' and orig_class==delta_class:
        return 1
